    ...
    users = [
        {
            ...
            "password": "demo123",
            "user_metadata": {"name": "Maya Chen", "role": "incident_commander", "avatar_initials": "MC"},
        },
        {
            "email": "samir.patel@incidentops.dev",
            "password": "demo123",
            "user_metadata": {"name": "Samir Patel", "role": "responder", "avatar_initials": "SP"},
        },
        {
            "email": "lena.ortiz@incidentops.dev",
            "password": "demo123",
            "user_metadata": {"name": "Lena Ortiz", "role": "admin", "avatar_initials": "LO"},
        },
    ]
    ...
    for user in users:
        ...
        try:
            ...
            response = supabase.auth.admin.create_user(
                {"email": user["email"], "password": user["password"], "user_metadata": user["user_metadata"], "email_confirm": True}
            )
