  ...
  return (
    <div className="animate-enter">
      <PageTitle
        ...
        action={<button className="focus-ring inline-flex items-center justify-center gap-2 rounded-xl bg-sky-400 px-4 py-2.5 text-sm font-semibold text-slate-950 transition hover:bg-sky-300"><Plus size={16} />Declare incident</button>}
      />
